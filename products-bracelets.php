            ...
            <div class="products-wrap">
                <aside id="sidebar">
                    <div class="widget">
                        ...
                        <form action="products-bracelets.php" method="POST">
                            <fieldset class="form">
                ...
                <p class="categories"> <?php $filter = $_POST['collection'] ?? 'Beaded collection';  echo "$filter" ?>
                </p>
                <div id="content">
                    <section class="products">
                        <?php            
              $result = mysqli_query($link1, "SELECT * FROM bracelets WHERE collections = '{$filter}'  " );
